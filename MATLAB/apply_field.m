function noise = apply_field(pts, table, unit, harmonics, roughness, fill)
%APPLY_FIELD Applies an octave noise field to a set of a points
%   noise = APPLY_FIELD(PTS, TABLE, UNIT, HARMONICS, ROUGHNESS, FILL)
...
%
%   noise = APPLY_FIELD(PTS, TABLE, CFG) packs the arguments above into a
%   structure CFG
